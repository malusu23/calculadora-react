# Reto calculadora REACT

Este es un ejercicio para crear una calculadora implementada en React

## Instrucciones

1. Crea los componentes necesarios para la calculadora.
...
-   Si la calculadora no sigue el esquema propuesto, no utiliza los componentes adecuadamente o no hace las operaciones indicadas, recibirás una nota del 0 al 5
-   Si la calculadora sigue el esquema propuesto, utiliza los componentes adecuadamente y hace las operaciones indicadas, recibirás una nota del 5 al 7
